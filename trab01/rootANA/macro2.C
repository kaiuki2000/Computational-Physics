...
void macro2()
{
    ...
    tpad1->cd();
    tpad1->SetGrid();
    TH1F *hr = tpad1->DrawFrame(1844, -7e4, 2025, 7e4);
    hr->SetXTitle("Year");
    hr->SetYTitle("Derivative");
    ...
    auto Gdata = D.GetDataDerivativeGraph(); // use marker style 20, marker size 0.4 and color kBlue+1. the TGraph should be named 'Gdata'
