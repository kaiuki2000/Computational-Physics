...
//Romberg method for integration: stops when relative error is smaller than 'RelError'
int Integrator::RombergRelativeError(double &Integral, double &Error, double RelError)
{
    int MatrixSize = 2;

    do
    {
        Romberg(MatrixSize, Integral, Error);
        MatrixSize++;
